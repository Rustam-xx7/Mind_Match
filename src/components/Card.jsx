...
export default function Card({ card, onClick }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Card Back (Closed Side - Universally dark gradient for premium contrast) */}
        <div className="absolute inset-0 w-full h-full backface-hidden rounded-2xl bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 border border-white/10 shadow-lg flex items-center justify-center overflow-hidden transition-all duration-300">
        ...
        {/* Card Front (Open Side - Pastel green in light mode, slate-gray in dark mode) */}
        <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl bg-[#e2f5e9] dark:bg-slate-900 border-2 border-emerald-200/80 dark:border-white/15 shadow-xl flex items-center justify-center overflow-hidden transition-all duration-300">
          {isMatched && (
